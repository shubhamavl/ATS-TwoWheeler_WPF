    ...
    public partial class LogFilesManagerWindow : Window
    {
        ...
        private void LoadFiles()
        {
            try
            {
                ...
                {
                    var csvFiles = Directory.GetFiles(dataDir, "two_wheeler_log_*.csv", SearchOption.TopDirectoryOnly);
                ...
                {
                    var txtFiles = Directory.GetFiles(logsDir, "two_wheeler_log_*.txt", SearchOption.TopDirectoryOnly);
