# ATS_TwoWheeler_WPF - Complete Feature List
...
- ✅ **Timestamped Log Files** - Files named with date/time: `two_wheeler_log_YYYYMMDD_HHMMSS.csv`
...
- ✅ **Configuration File** - `TwoWheeler_Config.json` for adapter settings
...
- ✅ **Adapter Config File** - `TwoWheeler_Config.json`
